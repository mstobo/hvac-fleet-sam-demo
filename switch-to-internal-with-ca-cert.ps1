...
Write-Host "   curl -u sr-developer:REDACTED https://apis.$HOSTNAME_SUFFIX/apis/registry/v3/system/info"
Write-Host ""
...
Test Commands:
  ...
  curl -u sr-developer:REDACTED https://apis.$HOSTNAME_SUFFIX/apis/registry/v3/system/info
